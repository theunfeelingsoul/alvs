            ...
            <div class="center_column col-xs-12 col-sm-9" id="center_column">
                ...
                <div class="category-slider">
                    <ul class="owl-carousel owl-style2" data-dots="false" data-loop="true" data-nav = "true" data-autoplayTimeout="1000" data-autoplayHoverPause = "true" data-items="1">
                        <li>
                            <!-- <img src="<?=Url::base()?>/01theme_back/assets/data/category-slide.jpg" alt="category-slider"> -->
                            <?= Html::img('@web/01theme_back/assets/data/category-slide.jpg', ['alt'=>'home image']); ?>
                        </li>
                        <li>
                            <!-- <img src="<?=Url::base()?>/01theme_back/assets/data/slide-cart2.jpg" alt="category-slider"> -->
                            ...
                            <li class="col-sx-12 col-sm-4">
                                <div class="product-container">
                                    <div class="left-block">
                                        <a href="#">
                                            <img class="img-responsive" alt="product" src="<?=Url::base().'/'.$value['img'][0]?>" />
                                        </a>
                                    ...
                                    <div class="right-block">
                                        ...
                                        <div class="content_price">
                                            <span class="price product-price"><?=$value['p_price'] ?>    </span>
