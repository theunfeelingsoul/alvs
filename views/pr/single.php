                                            ...
                                            <?php foreach ($pimages as $key => $value): ?>
                                                <li>
                                                    <a href="#" data-image="<?=Url::base()."/".$value?>" data-zoom-image="<?=Url::base()."/".$value?>">
                                                        <img id="product-zoom"  src="<?=Url::base()."/".$value?>" /> 
                                                    </a>
                                                </li>
                                            <?php endforeach ?>
                                            
                                            <!-- <li>
                                                <a href="#" data-image="<?=Url::base()?>/theme/data/product-s2-420x512.jpg" data-zoom-image="<?=Url::base()?>/theme/data/product-s2-850x1036.jpg">
                                                    <img id="product-zoom"  src="<?=Url::base()?>/theme/data/product-s2-100x122.jpg" /> 
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#" data-image="<?=Url::base()?>/theme/data/product-420x512.jpg" data-zoom-image="<?=Url::base()?>/theme/data/product-850x1036.jpg">
                                                    <img id="product-zoom"  src="<?=Url::base()?>/theme/data/product-100x122.jpg" /> 
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#" data-image="assets/data/product-s4-420x512.jpg" data-zoom-image="<?=Url::base()?>/theme/data/product-s4-850x1036.jpg">
                                                    <img id="product-zoom"  src="<?=Url::base()?>/theme/data/product-s4-100x122.jpg" /> 
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#" data-image="<?=Url::base()?>/theme/data/product-s5-420x512.jpg" data-zoom-image="<?=Url::base()?>/theme/data/product-s5-850x1036.jpg">
                                                    <img id="product-zoom"  src="<?=Url::base()?>/theme/data/product-s5-100x122.jpg" /> 
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#" data-image="<?=Url::base()?>/theme/data/product-s6-420x512.jpg" data-zoom-image="<?=Url::base()?>/theme/data/product-s6-850x1036.jpg">
                                                    <img id="product-zoom"  src="<?=Url::base()?>/theme/data/product-s6-100x122.jpg" /> 
                                                </a>
                                            </li> -->
                                        </ul>
                                    </div>
